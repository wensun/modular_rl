...
if __name__ == "__main__":
    ...
    if cfg["env"] == 'Swimmer-v1' or cfg["env"] == "Walker2d-v1" or cfg["env"] == "Hopper-v1":
...
cPickle.dump(agent, open("expert_models/Perfect_ExpertAgent_{}_{}".format(cfg['env'], cfg['agent']), 'wb'));
